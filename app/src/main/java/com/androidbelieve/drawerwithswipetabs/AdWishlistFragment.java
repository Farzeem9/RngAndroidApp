...
public class AdWishlistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = (ViewGroup) inflater.inflate(R.layout.ads_wishlist_tab, null);
        ...
        if (!result.equals("{\"result\":[]}")) {
            for (int i = 0; i < jarray.length(); i++) {
                try {
                    ...
                    Ads a = new Ads(cat, name, amount, timestamp, aid);
                    list_ad.add(a);
