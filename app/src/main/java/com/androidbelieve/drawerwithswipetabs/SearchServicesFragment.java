 ...
 * {@link SearchServicesFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SearchServicesFragment#newInstance} factory method to
...
public class SearchServicesFragment extends Fragment {
    ...
    private ArrayList<ServiceAlbum> albumListservice=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapterservice=new ServiceCategoryAdapter(getContext(),albumListservice);
        recyclerViewservice=(RecyclerView)view.findViewById(R.id.recycler_view);
        RecyclerView.LayoutManager mLayoutManagerservice = new GridLayoutManager(getContext(), 1);
