...
/**
 * Created by karth on 15-12-2016.
 */
...
public class BlurC {
    ...
    static public class BlurFactor {
        ...
        public static Bitmap of(Context context, Bitmap source, BlurFactor factor) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
                try {
                    bitmap = jp.wasabeef.blurry.internal.Blur.rs(context, bitmap, factor.radius);
                } catch (RSRuntimeException e) {
                    bitmap = jp.wasabeef.blurry.internal.Blur.stack(bitmap, factor.radius, true);
                }
            } else {
                bitmap = jp.wasabeef.blurry.internal.Blur.stack(bitmap, factor.radius, true);
            }
