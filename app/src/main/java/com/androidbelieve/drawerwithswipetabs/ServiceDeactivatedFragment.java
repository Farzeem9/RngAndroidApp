...
public class ServiceDeactivatedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new ServiceAsyncTask(Config.link+"myservices.php?pid="+ AccessToken.getCurrentAccessToken().getUserId()+"&status=DEACTIVATED",serviceAdapter,list_service).execute();
